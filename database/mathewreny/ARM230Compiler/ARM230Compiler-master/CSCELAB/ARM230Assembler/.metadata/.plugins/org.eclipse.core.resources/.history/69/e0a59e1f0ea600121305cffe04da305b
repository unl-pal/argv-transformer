...
//There is at least function at the bottom...
	...
	public static void main(String[] args){
		...
		//***************************************************
		//THE FOLLOWING ARE DIFFERENT TESTS FOR RUNNING	IN	*
		//ECLIPSE. SET THESE TO SPECIFIED VALUE WHEN DONE	*
		//***************************************************
...
//THE BELOW CODE WORKS BUT HAS NOT BEEN VERIFIED 100%
