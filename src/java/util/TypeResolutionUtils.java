...
public class TypeResolutionUtils {
  ...
  public static void safeRemoveOrReplace(Expression node, ASTRewrite rewriter, AST ast, Boolean randUsedInMethod) {
    ...
    while (ancestor != null && !(ancestor instanceof Block) && !(ancestor instanceof MethodDeclaration)) {
      ...
      if (ancestor == null || ancestor.getParent() instanceof Block
          || ancestor.getParent() instanceof MethodDeclaration) {
  ...
  public static void replaceArgumentWithinMethodInvocation(ASTNode node, MethodInvocation parentInvocation,
      ASTRewrite rewriter, AST ast, Boolean randUsedInMethod) {
  ...
  /**
   * Returns true if the given exception type binding represents a checked
   * exception,
   * false otherwise (i.e., unchecked exceptions: RuntimeException, Error, and
   * their subclasses).
   */
  ...
  public static void replaceBoolean(Expression exp, String target, AST ast, ASTRewrite rewriter,
  ...
  public static Expression generateBooleanFromTarget(AST ast, Boolean randUsedInMethod, String target) {
    switch (target) {
      case "SPF":
        return replaceWithSymbolicBoolean(ast);
      case "SVCOMP":
        return replaceWithNodeBoolean(ast, randUsedInMethod);
      default:
        return replaceWithRandomBoolean(ast, randUsedInMethod);
    }
  }
  ...
  public static void replaceInteger(Expression exp, String target, AST ast, ASTRewrite rewriter,
      Boolean randUsedInMethod) {
  ...
  public static Expression generateIntegerFromTarget(AST ast, Boolean randUsedInMethod, String target) {
    switch (target) {
      case "SPF":
        return replaceWithSymbolicInteger(ast);
      case "SVCOMP":
        return replaceWithNodeInteger(ast, randUsedInMethod);
      default:
        return replaceWithRandomInteger(ast, randUsedInMethod);
    }
  }
  ...
  public static void replaceDouble(Expression exp, String target, AST ast, ASTRewrite rewriter,
      Boolean randUsedInMethod) {
  ...
  public static Expression generateDoubleFromTarget(AST ast, Boolean randUsedInMethod, String target) {
    switch (target) {
      case "SPF":
        return replaceWithSymbolicDouble(ast);
      case "SVCOMP":
        return replaceWithNodeDouble(ast, randUsedInMethod);
      default:
        return replaceWithRandomDouble(ast, randUsedInMethod);
    }
  }
  ...
  public static void replaceFloat(Expression exp, String target, AST ast, ASTRewrite rewriter,
      Boolean randUsedInMethod) {
  ...
  public static Expression generateFloatFromTarget(AST ast, Boolean randUsedInMethod, String target) {
    switch (target) {
      case "SPF":
        return replaceWithSymbolicFloat(ast);
      case "SVCOMP":
        return replaceWithNodeFloat(ast, randUsedInMethod);
      default:
        return replaceWithRandomFloat(ast, randUsedInMethod);
    }
  }
